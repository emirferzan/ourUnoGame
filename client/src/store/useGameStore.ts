...
export interface Player { id: string; name: string; hand: Card[]; hasCalledUno: boolean; isBot?: boolean; }
...
interface GameState {
  ...
  setIds(roomId: string, playerId: string): void;
  setState(payload: { game: Game; you?: Player }): void;
  setColorPickerOpen(v: boolean): void;
}

export const useGameStore = create<GameState>((set) => ({
  colorPickerOpen: false,
  setIds: (roomId, playerId) => set({ roomId, playerId }),
  setState: ({ game, you }) => set({ game, you }),
